	    ...
	    <div class="form_01 personal_date">
	        ...
	        <ul>
		        <li class="rgs_name_li">
		            ...
		            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" placeholder="이름">
		            <?php
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	...
	<?php } ?>
	    ...
	    <div class="form_01 personal_setting">
	        ...
	        <ul>
		        ...
		        <li>
		        	<div class="frm_bar">
		            	<label for="reg_mb_open" class="frm_label info_open"><span class="sound_only">정보공개</span><span class="frm_check frm_check3"></span></label>
    ...
    <div class="btn_confirm">
	    ...
	    <button type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn_submit" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
	</div>
