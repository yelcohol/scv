...
<div class="lt_basic">
    ...
    <?php for ($i=0; $i<count($list); $i++) { ?>
        <li>
        	<span class="lt_writer"><?php echo get_member_profile_img($member['mb_id']); ?></span>
            <?php
    ...
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>" class="lt_more"><i class="fas fa-ellipsis-v"></i><span class="sound_only"><?php echo $bo_subject ?> 더보기</span></a>
</div>
