...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <div class="scdate-txt">
            <?php
            if ($view['wr_6'] == $view['wr_16']) {
                echo '<span class="date-txt">'.wz_get_hangul_date($view['wr_6']).' 진행 시간: '.$view['wr_7'].' ~ '.$view['wr_8'].'</span>';
            }
            else {
                echo '<span class="date-txt">'.wz_get_hangul_date($view['wr_6']).'</span> 부터 <span class="date-txt">'.wz_get_hangul_date($view['wr_16']).'</span> 까지';
            }
            ?>
        </div>
