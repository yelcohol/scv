...
<div id="memo_write" class="new_win">
    ...
    <div class="new_win_con2">
        ...
        <div class="form_01">
            ...
            <ul>
                <li>
                    ...
                    <span class="frm_info">공고 담당자에게 하고싶은 말씀을 간단하게 적어주세요.</span>
                </li>
                <li>
                    <label for="me_memo" class="sound_only">내용</label>
                    <textarea name="me_memo" id="me_memo" value="잘 부탁드립니다." required class="required"><?php //echo $content ?></textarea>
                </li>
                <li>
        ...
        <div class="win_btn">
        	<button type="submit" id="btn_submit" class="btn btn_b02 reply_btn">지원메시지 보내기</button>
