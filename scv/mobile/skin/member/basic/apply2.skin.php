...
<div id="apply" class="new_win">
    ...
    <div id = "apply" class = "new_win_con">
    <ul>
        ...
        <li>
            ...
            if($list[$i]['ma_state']=='지원검토중'){ ?>
                <a href="<?php echo $list[$i]['accept_href'];  ?>" onclick="accept(this.href); return false;" class="apply_accept"><span>합격 처리</span></a>
                <a href="<?php echo $list[$i]['refuse_href'];  ?>" onclick="refuse(this.href); return false;" class="apply_refuse"><span>불합격 처리</span></a>
