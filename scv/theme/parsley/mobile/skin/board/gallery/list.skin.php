	            ...
	            <div class="gall_li_wr">
	                ...
	                <div class="gall_img_area">
		                ...
		                <div class="gall_recomm">
	                        <?php if ($is_good) { ?><span class="reco reco_good"><span class="sound_only">추천</span><strong><i class="far fa-smile-wink"></i> <?php echo $list[$i]['wr_good'] ?></strong></span><?php } ?>
	                        <?php if ($is_nogood) { ?><span class="reco reco_nogood"><span class="sound_only">비추천</span><strong><i class="far fa-angry"></i> <?php echo $list[$i]['wr_nogood'] ?></strong></span><?php } ?>
	                    </div>   	
	                </div>
